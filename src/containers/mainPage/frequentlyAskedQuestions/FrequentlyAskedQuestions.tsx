...
export const FrequentlyAskedQuestions = () => {
  ...
  return (
    <Grid container width="100%" direction="row" flexWrap="nowrap" px="10%" py="64px">
      <Grid container item direction="column" flexWrap="nowrap" xs={7}>
        <Typography variant="h3" color="primary">
          Frequently Asked Questions
        </Typography>
        <Grid container direction="column" flexWrap="nowrap" py="64px">
      ...
      <Grid item xs={5}>
        <Grid component="img" src={questionSrc} />
      </Grid>
    </Grid>
  );
};
